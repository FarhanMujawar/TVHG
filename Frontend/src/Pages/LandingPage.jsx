  ...
  return (
    <div ref={app} style={{ marginTop: '-64px', position: 'relative' }}>
        ...
        >
          ...
          <Stack height={isMobile?'40rem':'unset'} justifyContent={isMobile? 'center' :'unset'} ref={textRef} width={isMobile? '17rem' : 'unset'} alignItems={'flex-start'} ml={isMobile? '3rem':'5rem'}>
            ...
            <Typography className="animated-text" variant="body1" color="white" gutterBottom margin={'17px 0px 21px 0px'} style={{textShadow:'rgb(15 15 15) 2px 2px'}}>
              The Virtual Healing Garden is a digital platform that harnesses the healing power of plants and herbs by combining ancient knowledge with modern technology. It offers seamless access to natural remedies, making traditional herbal wisdom both accessible and relevant for today’s generation.
            </Typography>
      ...
      <Box
        ...
        alignItems={'center'}
      >
        <Typography variant="h4">Discover the Future of Healing Garden</Typography>
